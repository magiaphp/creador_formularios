...
"type" => "text",
"name" => "opciones_opcion",
"value" => "$opciones_opcion",                                                                        
...
"type" => "text",
"name" => "opciones_estatus",
"value" => "$opciones_estatus",                                                                        
    
"for" => "opciones_estatus",
"label" => "estatus",
"class" => "form-control",
"id" => "opciones_estatus",
"placeholder" => "estatus",
