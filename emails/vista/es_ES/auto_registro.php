...
$body .= "<p>Ud. (u otra persona), ha solicitado el acceso a la plataforma web para realizar pedidos en: $config_nombre_web</p></p>";
$body .= "<p>Un mensaje ha sido enviado al administrador para que apruebe su registro, una vez aprobado podra realizar pedidos</p>";
